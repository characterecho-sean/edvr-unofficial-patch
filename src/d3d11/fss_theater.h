...
// contentTexR: the RIGHT eye's submit, for the nose-mask stitch (may be
// null: the left eye alone draws). rect: BOTH eyes' projected corners of
// the scanner's screen (16 floats, left set then right set), derived per
// engage by fss_panel_rect; null falls back to the centred aspect band.
__declspec(dllexport) void* edvrFssTheater(void* contentTex,
                                           void* contentTexR, int eye,
