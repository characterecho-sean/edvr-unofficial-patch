...
//
//   Door 1  IDirectInputDevice8::GetDeviceState / GetDeviceData, reached
//           through the shared vtable of a dummy keyboard device EDVR
...
// Called lazily by the menu on its first use, from the frame thread.
