...
// orientation (a game that submitted flipped v stays flipped). Returns
// null on any failure -- wrong texture kind, MSAA or array source, create
// or copy failure, fault budget spent -- and the caller must stand the
// guard down rather than submit a frame whose projection and image
// disagree.
