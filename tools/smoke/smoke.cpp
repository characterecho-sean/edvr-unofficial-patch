    ...
    // resolve's tests: before the scene-counter block and its device hang.
    {
        ...
        if (!taa) {
            ...
            if (!makeSolidSrc(device, ctx, 400, 304, colourA, true, &srcA) ||
                ...
                void* r1 = taa(srcA, 0, nullptr, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1,
                               0.9f, 1.0f, 1u);
                ...
                void* r2 = taa(srcA, 0, nullptr, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1,
                               0.9f, 1.0f, 0u);
                ...
                void* r3 = taa(srcB, 0, nullptr, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1,
                               0.9f, 1.0f, 0u);
                ...
                void* r4 = taa(srcB, 0, nullptr, tan, tan, 0.0f, 0.0f, nullptr, nullptr, nullptr, 0.0f, 0,
                               0.9f, 1.0f, 0u);
                if (!checkResolved(device, ctx, r4, "temporal: motion 'none' blends in place",
                                   400, 304, 200, 152, br, bg, bb, 2)) rc = 1;
                // The other eye is its own history: eye 1 starts afresh.
                void* r5 = taa(srcA, 1, nullptr, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1,
                               0.9f, 1.0f, 0u);
            ...
            // not read the left's, at its leftmost column, history or not.
            {
                ...
                if (!makeSolidSrc(device, ctx, 800, 304, left, true, &wide) ||
                    ...
                    ctx->CopySubresourceRegion(wide, 0, 400, 0, 0, half, 0, &box);
                    const float bR[4] = {0.5f, 0.0f, 1.0f, 1.0f};
                    void* r = taa(wide, 1, bR, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1, 0.9f, 1.0f, 1u);
                    if (!checkResolved(device, ctx, r, "temporal: right eye of a double-wide, leftmost column (no bleed)",
                                       400, 304, 0, 152, br, bg, bb, 2)) rc = 1;
                    r = taa(wide, 1, bR, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1, 0.9f, 1.0f, 0u);
            ...
            }
            {
                ...
                if (SUCCEEDED(device->CreateTexture2D(&td, nullptr, &msaa)) && msaa) {
                    if (!expectRefused(taa(msaa, 0, nullptr, tan, tan, 0.0f, 0.0f, ident, nullptr, nullptr, 0.0f, 1, 0.9f, 1.0f, 1u),
